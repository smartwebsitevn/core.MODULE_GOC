...
class Goc_cat_model extends Core_hiarachy_model
{
    public $table = 'goc_cat';
   // public $order = array(array('created', 'desc'), array('id', 'desc'));
    ...
    public $fields_filter = array(
       //== parent
        'parent_id','!parent_id','parent_id_gt', 'parent_id_gte', 'parent_id_lt', 'parent_id_lte',
        'level', 'level_gt', 'level_gte', 'level_lt', 'level_lte',
