...
class Module extends \MY_Module
{
	...
	{
		t('lang')->load('admin/goc');
		$ids = array_pluck(model('goc')->get_list(), 'name', 'id');
		$cat_ids = array_pluck(model('goc_cat')->get_hierarchy_data(), '_name', 'id');
