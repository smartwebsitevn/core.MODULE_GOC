...
$_macro['toolbar_sub'] = array(
    array('url' => admin_url('goc'), 'title' => lang('mod_goc'),'attr'=>array('class'=>'active')),
    array('url' => admin_url('goc_cat'), 'title' => lang('mod_goc_cat'), )
);
	...
	<div class="portlet">
		<div class="portlet-heading dark">
			<div class="portlet-title">
				<h4><i class="fa fa-pencil"></i> <?php echo lang('mod_goc'); ?></h4>
			</div>
			...
			<form class="form form-horizontal" id="form" method="post" action="<?php echo $action; ?>">
				<div class="tc-tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_general"><?php t('view')->load('tpl::goc/form/general'); ?></div>
						<div class="tab-pane" id="tab_detail"><?php t('view')->load('tpl::goc/form/detail'); ?></div>
                           <?php /*?>
                         <div class="tab-pane" id="tab_advance"><?php t('view')->load('tpl::goc/form/advance'); ?></div>
                           <?php */?>    
