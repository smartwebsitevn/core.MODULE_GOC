<?php if (isset($list) && $list): ?>
        ...
        <div class="item-kh">
            <div class="item-info">
                <div class="item-photo">
                    ...
                    <?php echo view('tpl::_widget/goc/display/item/info_label', array('info' => $row)); ?>
                    <?php //echo view('tpl::_widget/goc/display/item/info_author', array('info' => $row)); ?>
                    <?php //echo view('tpl::_widget/goc/display/item/info_stats', array('info' => $row)); ?>
                </div>
                <div class="item-detail">
                    <strong class="item-name"><a href="<?php echo $row->_url_view; ?>"> <?php echo $row->name; ?></a></strong>
                    <div class="item-author"><?php echo $row->_cat_name;;//character_limiter($row->target, 50); ?></div>
    ...
    <?php if (t('input')->is_ajax_request() && isset($pages_config)) : ?>
        <?php widget('goc')->display_pagination($pages_config); ?>
    <?php endif; ?>
